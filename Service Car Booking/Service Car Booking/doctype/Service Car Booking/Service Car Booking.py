...
class Service Car Booking(WebsiteGenerator):
	website = frappe._dict(
		template = "templates/generators/Service Car Booking.html"
	)
	...
	def sync_todos(self):
		...
		for todo in todos_added:
			...
			todo.flags.from_Service Car Booking = True
			todo.delete()

	def get_context(self, context):
		context.parents = [{"name": "Service Car Bookings", "title": "Service Car Bookings"}]
